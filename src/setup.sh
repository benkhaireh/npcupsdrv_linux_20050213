...
echo "Star Micronics"
echo "npcupsdrv-2.3.0 installer"
echo "---------------------------------------"
echo ""
...
echo "Copying rastertonp filter to $DESTDIR/$FILTERDIR"
mkdir -p $DESTDIR/$FILTERDIR
chmod +x rastertonp
cp rastertonp $DESTDIR/$FILTERDIR
echo ""
